...
function ScriptVersions() {
  return <article className="mx-auto w-full min-w-0 max-w-3xl space-y-5 leading-relaxed [&_pre]:whitespace-pre-wrap [&_pre]:break-all [&_pre]:rounded [&_pre]:bg-gray-100 [&_pre]:p-4">
    ...
    <p>Details is divided into General, Command, Access, Schedule, and Upgrade. Save highlights sections and fields needing correction. Apply arguments changes the form. Save persists it. Custom-run overrides are never saved to the script.</p>
