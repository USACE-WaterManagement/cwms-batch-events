...
function Admin() {
  ...
  if (!auth.isAuth) return <LoginPrompt title="Sign in to view administration" description="The HQ CWMS Admin role is required." />;
  ...
  if (access.data !== true) return <StatePage kind="access" title="Administration access required"><p>The HQ CWMS Admin role is required. Contact your HQ administrator to request access.</p></StatePage>;
