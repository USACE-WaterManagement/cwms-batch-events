...
class JobDatabase(Protocol):
    def get_script_by_id(self, script_id: UUID) -> ScriptRead: ...
    ...
    def count_jobs_for_offices(self, offices: list[str], script_id: UUID | None = None, submitted_from: datetime | None = None, submitted_before: datetime | None = None) -> int: ...
